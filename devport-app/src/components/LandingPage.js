...
const LandingPage = () => {
  ...
  return (
    <div id='LPContainer'>
      ...
      <section id='Valueproposition' loading="lazy">
        <div className='typewriter'>
          ...
          <div className='typewriter'>
            ...
            <p className='Valueproposition-p'>Click the Get Started button, you'll be redirected to authenticate with your GitHub account. On successful authentication, you're redirected to the portfolio page where you fill in your details, when you're done, click Generate CV on the navigation bar and you'll be presented with a button to download a PDF copy of your newly created portfolio.</p>
