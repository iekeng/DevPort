...
const SignUp = () => {
    ...
    return (
        <div className="container">
            ...
            <button id="signupbutton" type='submit' className="LSbutton" style={{ borderRadius: '5px', boxShadow: '5px 5px 5px black', display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
